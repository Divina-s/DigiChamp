...
class SubmitSingleAnswerView(APIView):
    def post(self, request, question_id):
        ...
        logger.info(f"Selected Option ID: {selected_option_id}, Question ID: {question_id}")
...
class QuizQuestionsByTopicAndLevel(APIView):
    def get(self, request):
        ...
        # Default to "beginner" and ignore capitalization
        level = request.GET.get('level', 'beginner').lower()
